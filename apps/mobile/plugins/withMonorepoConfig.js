...
function withMonorepoConfig(config) {
  return withAppBuildGradle(config, (config) => {
    ...
    // The default block generated by prebuild starts with `react {` and ends with `}`
    // It may contain various properties like autolinkLibrariesWithApp()
    const reactBlockRegex = /(?:\/\/[^\n]*\n)*react\s*\{[^}]*(?:\{[^}]*\}[^}]*)*\}/;
